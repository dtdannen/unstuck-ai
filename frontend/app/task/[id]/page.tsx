...
export default function TaskPage({ params }: TaskPageProps) {
  ...
  async function submitBid() {
    ...
    try {
      ...
      // Create a bid event (kind 7000)
      const tags = [
        ["e", task.id], // Reference to the original task
        ["p", task.author.pubkey], // Tag the task creator
        ["amount", "100"], // Bid amount in sats
        ["bolt11", "lnbc1000n1pjqxyz..."] // Lightning invoice (would be generated by a wallet)
      ]
      
      const bidEvent = await createSignedEvent(
        7000,
        "I'd like to complete this task for 100 sats",
        tags
      )
